...
import com.springcloud.microservices.currencyconversionservice.CurrencyExchangeServiceFeignClient;
...
public class CurrencyConversionController {
	...
	public CurrencyConversion convertCurrencyFeign(@PathVariable String from, @PathVariable String to,
		...
		CurrencyConversion response = currencyExchangeFeign.retrieveExchangeValue(from, to);
